...
test.describe('Login', () => {
    ...
    test.describe('ProfileMenuLogoutDropdown', () => {
        test.beforeEach(async ({ loginModule, dashboardModule, dashboardPage, page }) => {
            const appCredentials = credentials('app');
        ...
        test('[TC_008] Logout ends the authenticated session and returns to Login @ProfileMenuLogoutDropdown @Positive', async ({
            dashboardModule,
            loginPage,
            page,
        }) => {
